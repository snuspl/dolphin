...
# EXAMPLE USAGE 
# ./run_kmeans.sh -numCls 4 -convThr 0.01 -maxIter 20 -local true -split 4 -input dolphin-bsp/src/test/resources/data/clustering -output output_kmeans -maxNumEvalLocal 5
