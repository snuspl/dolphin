 ...
 */
package edu.snu.reef.dolphin.util;

import org.apache.reef.io.network.Message;

/**
 * Utility class for using {@link Message}.
 */
public final class SingleMessageExtractor {
  ...
  /**
   * Checks that a given {@link Message} contains exactly one inner message and returns it.
   *
   * @param msg message to check
   * @return the single message that is contained in {@code msg}
   */
