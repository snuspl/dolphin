 ...
 */
public final class ServerSideMsgSender<K, V> {
  ...
  @Inject
  private ServerSideMsgSender(final PSNetworkSetup psNetworkSetup,
   ...
   * This message is a reply to a {@link edu.snu.reef.dolphin.ps.avro.PullMsg}.
