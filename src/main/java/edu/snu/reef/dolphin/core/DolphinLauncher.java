...
public final class DolphinLauncher {
  ...
  /**
   * Dolphin Launcher constructor - instantiated by Tang.
   *
   * @param dolphinParameters Parameters for Dolphin Launcher
   */
  @Inject
  ...
  /**
   * Run Dolphin Launcher using the given Tang configuration.
   *
   * @param dolphinConfig
   */
  public static void run(Configuration dolphinConfig) {
