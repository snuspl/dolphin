...
public final class NeuralNetParamWorkerData {
  ...
  public NeuralNetParamWorkerData(final Pair<ValidationStats, ValidationStats> validationStatsPair) {
  ...
  public NeuralNetParamWorkerData(final List<LayerParameter[]> layerParametersList) {
