...
import edu.snu.reef.dolphin.examples.ml.loss.LogisticLoss;
import edu.snu.reef.dolphin.examples.ml.loss.Loss;
import edu.snu.reef.dolphin.examples.ml.parameters.*;
import edu.snu.reef.dolphin.examples.ml.regularization.L2Regularization;
import edu.snu.reef.dolphin.examples.ml.regularization.Regularization;
