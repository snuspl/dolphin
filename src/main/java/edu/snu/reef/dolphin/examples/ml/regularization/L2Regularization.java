 ...
 */
package edu.snu.reef.dolphin.examples.ml.regularization;

import edu.snu.reef.dolphin.examples.ml.data.Model;
import edu.snu.reef.dolphin.examples.ml.parameters.Lambda;
