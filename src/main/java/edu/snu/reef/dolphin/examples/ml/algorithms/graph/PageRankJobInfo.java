...
import edu.snu.reef.dolphin.examples.ml.data.AdjacencyListParser;
import edu.snu.reef.dolphin.examples.ml.parameters.CommunicationGroup;
import edu.snu.reef.dolphin.examples.ml.sub.PageRankCodec;
import edu.snu.reef.dolphin.examples.ml.sub.PageRankReduceFunction;
import edu.snu.reef.dolphin.examples.ml.sub.PageRankSummaryCodec;
