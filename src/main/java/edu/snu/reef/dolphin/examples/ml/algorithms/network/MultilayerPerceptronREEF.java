...
public class MultilayerPerceptronREEF {
  public static void main(final String[] args) throws Exception {
    DolphinLauncher.run(
        Configurations.merge(
            DolphinConfiguration.CONF(args, new CommandLine()),
            Tang.Factory.getTang().newConfigurationBuilder()
                .bindNamedParameter(JobIdentifier.class, "Multilayer perceptron")
                .bindImplementation(UserJobInfo.class, MultilayerPerceptronJobInfo.class)
                .build()
        )
    );
  }
