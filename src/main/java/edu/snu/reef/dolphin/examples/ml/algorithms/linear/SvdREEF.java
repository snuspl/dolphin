  ...
  public static void main(final String[] args) throws Exception {
    DolphinLauncher.run(
        Configurations.merge(
            DolphinConfiguration.CONF(args, SvdParameters.getCommandLine()),
            Tang.Factory.getTang().newConfigurationBuilder()
                .bindNamedParameter(JobIdentifier.class, "SVD")
                .bindImplementation(UserJobInfo.class, SvdJobInfo.class)
                .bindImplementation(UserParameters.class, SvdParameters.class)
                .build()
        )
    );
  }
