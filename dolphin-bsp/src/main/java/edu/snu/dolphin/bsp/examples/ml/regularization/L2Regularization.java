 ...
 */
package edu.snu.dolphin.bsp.examples.ml.regularization;

import edu.snu.dolphin.bsp.examples.ml.data.Model;
import edu.snu.dolphin.bsp.examples.ml.parameters.Lambda;
