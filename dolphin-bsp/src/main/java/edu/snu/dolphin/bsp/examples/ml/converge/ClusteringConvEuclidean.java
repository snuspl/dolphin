 ...
 */
package edu.snu.dolphin.bsp.examples.ml.converge;

import edu.snu.dolphin.bsp.examples.ml.data.EuclideanDistance;
import edu.snu.dolphin.bsp.examples.ml.parameters.ConvergenceThreshold;
